            ...
            <Card className="shadow-sm border-0 rounded">
              <Card.Body className="text-center py-5">
                <div className="mb-4">
                  ...
                  >
                    <LuChefHat size={40} className="text-danger" />
                  </div>
                </div>
                
                <h2 className="fw-bold text-dark mb-3">Receitas</h2>
                
                <p className="text-muted mb-4 lead">
                  Esta página está em desenvolvimento. Em breve você poderá adicionar e ver todas as receitas da empresa.
                </p>
